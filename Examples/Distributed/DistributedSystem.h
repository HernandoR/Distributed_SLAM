...
#ifndef ORB_SLAM3_DISTRIBUTEDSYSTEM_H
#define ORB_SLAM3_DISTRIBUTEDSYSTEM_H
...
namespace ORB_SLAM3
{
    ...
    public:
        ...
        Disti_System(const string &strVocFile, const string &strSettingsFile, const eSensor sensor, const bool bUseViewer = true, const int initFr = 0, const string &strSequence = std::string());
...
#endif //ORB_SLAM3_DISTRIBUTEDSYSTEM_H
