...
//    auto subSlam_ptr=StartSLAMSystem(argv[1],argv[2],nImages,vstrImageLeft, vstrImageRight, vTimestamps);
//    subSlam_ptr->SaveTrajectoryKITTI("CameraTrajectory.txt");
//    std::thread th1(StartSLAMSystem,argv[1],argv[2],nImages,vstrImageLeft, vstrImageRight, vTimestamps);
//    std::thread th2(StartSLAMSystem,argv[1],argv[2],nImages,vstrImageLeft, vstrImageRight, vTimestamps);
